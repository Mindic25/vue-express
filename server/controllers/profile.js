...
/* GET All Attacking Midfielder */
module.exports.attackMidview = (req, res, next) => {
  AttackMidFielder.find()
...
/* GET All CenterBack */
module.exports.centerBackview = (req, res, next) => {
  CenterBack.find()
    .select(' _id first last DOB phone')
    .exec()
    .then(docs => {
...
/* GET All FullBack */
module.exports.fullBackview = (req, res, next) => {
  Fullback.find()
    .select(' _id first last DOB phone')
    .exec()
    .then(docs => {
...
/* GET All GoalKeeper */
module.exports.goalKeeperview = (req, res, next) => {
  GoalKeeper.find()
    .select(' _id first last DOB phone')
    .exec()
    .then(docs => {
...
/* GET All HoldmidFielder */
module.exports.holdMidfieldview = (req, res, next) => {
  HoldMidFielder.find()
    .select(' _id first last DOB phone')
    .exec()
    .then(docs => {
...
/* GET All Striker */
module.exports.Strikerview = (req, res, next) => {
  Striker.find()
    .select(' _id first last DOB phone')
    .exec()
    .then(docs => {
...
/* GET All Wide Mid fielder */
module.exports.wideMidview = (req, res, next) => {
  WideMidFielder.find()
    .select(' _id first last DOB phone')
    .exec()
    .then(docs => {
...
module.exports.goalkeeperpost = (req, res, next) => {
  ...
  const goalkeeper = new GoalKeeper({
    ...
    power: req.body.power,
    reactime: req.body.reaction_time,
